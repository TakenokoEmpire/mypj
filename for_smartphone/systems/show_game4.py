...
class ShowGame(battle.Battle, town.Town):
    ...
    def set_town(self):
        ...
        for stage_minus1 in range(5):
            ...
            self.town_back_list[stage] = pygame.image.load("./mypj3/img/scenery/town{}.png".format(stage))
    ...
    def set_enemy(self):
        ...
        for stage_minus1 in range(15):
            stage = stage_minus1 + 1
            self.enemy_list[stage] = pygame.image.load("./mypj3/img/monster/enemy_{}.png".format(stage)).convert_alpha()
            self.enemy_list[stage] = pygame.transform.rotozoom(self.enemy_list[stage], 0, self.screen_size)
            self.enemy_back_list[stage] = pygame.image.load("./mypj3/img/scenery/sc{}.png".format(stage))
    ...
    #     """ステージセレクト画面
    #     """
    #     font = pygame.font.Font("./Harenosora.otf", 30*self.screen_size)
    #     level = font.render("ステージを選んで下さい", True, "WHITE")
    #     self.screen.blit(level, (11*self.screen_size, 10*self.screen_size))
    #     font2 = pygame.font.Font("./ALGERIA.TTF", 40*self.screen_size)
    ...
    def normal_stage(self, mode="normal"):
        ...
        if self.turn < 10:
            ...
            hit_blow = font4.render("Turn:{}  Hit:{}    Blow:{}".format(self.turn,self.hit,self.blow), True, (255,255,255))
        font = pygame.font.Font("./ALGERIA.TTF", 40*self.screen_size)
    ...
    def screen_select(self):
        ...
        font = pygame.font.Font("./Harenosora.otf", 100)
    ...
    def show_prologue(self):
        ...
        j = 0
        self.screen.fill((0,0,0))
        self.paper_img = pygame.image.load("./mypj3/img/paper.png")
    ...
    def show_map(self):
        self.world_map_image = pygame.image.load("./mypj3/img/world_map.jpg")
        ...
        self.arrow_image = pygame.image.load("./mypj3/img/arrow.png").convert_alpha()
        self.arrow_image = pygame.transform.rotozoom(self.arrow_image, 0, self.screen_size)
        self.stage_range_image = pygame.image.load("./mypj3/img/rect_70.png").convert_alpha()
